...
import com.diazneoones82.llamacpp.ILlamaService
...
class LlamaServiceTest {
    ...
    fun loadModel_returnsPositiveId() {
        ...
        val modelId = service!!.loadModel(modelFile!!.absolutePath, null, progress)
    ...
    fun loadModel_invalidPath_returnsZero() {
        ...
        val modelId = service!!.loadModel(bogus, null, progress)
    ...
    fun loadModelByPfd_returnsPositiveId() {
        ...
        val modelId = service!!.loadModel(null, pfd, progress)
