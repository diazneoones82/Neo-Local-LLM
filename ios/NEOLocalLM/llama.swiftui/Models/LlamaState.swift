...
enum ModelCatalog {
    static let localModels: [LocalModel] = [
        ...
        LocalModel(id: "deepseek-v4-flash-mtp", name: "DeepSeek V4 Flash MTP", filename: "DeepSeek-V4-Flash-MTP-Q4K-Q8_0-F32.gguf", url: URL(string: "https://huggingface.co/antirez/deepseek-v4-gguf/resolve/main/DeepSeek-V4-Flash-MTP-Q4K-Q8_0-F32.gguf")!, additionalFiles: [], description: "Antirez DeepSeek V4 Flash MTP GGUF - 3.81Gb - Q4K/Q8_0/F32", isDefault: false),
